...
public class AccountantDetails extends JFrame {
    ...
    AccountantDetails sframe;
	public AccountantDetails(int id,String userName) {
	...
	public static void main(String args[]) {
		new AccountantDetails(1,"Musthafa").setVisible(true);;
	}
}
