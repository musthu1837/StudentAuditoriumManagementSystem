...
public class SalesPersonAdd extends JFrame {
	...
	public SalesPersonAdd(int id,String userName) {
		this.userName = userName;
		this.id = id;
		//settings for window
		setResizable(false);
		setTitle("SalesPerson Add");
		...
		updateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(id !=0) {
						JOptionPane.showMessageDialog(contentPane, "SalesPerson already exits with "+mobilenumber,"Sorry",JOptionPane.ERROR_MESSAGE);						
						return;						
					}
						
					db.insertUser(name,gender,age,mobilenumber,email,address,username,password,0,0,0,1);		
				    JOptionPane.showMessageDialog(contentPane, "Sales person added successfully !");				    
				    
									    
				    ShowManagerFrame frame = new ShowManagerFrame(id,userName);
	...
	public static void main(String args[]) {
		new SalesPersonAdd(1,"Musthafa").setVisible(true);;
	}
}
