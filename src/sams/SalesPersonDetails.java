...
public class SalesPersonDetails extends JFrame {
    ...
    SalesPersonDetails sframe;
	public SalesPersonDetails(int id,String userName) {
		...
		updateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					db.connect();						
					db.updateUser(name,gender,age,mobilenumber,email,address,username,password,sframe.id);		
				    JOptionPane.showMessageDialog(contentPane, "Profile updated successfully !");				    
				    
									    
				    SalesPersonFrame frame = new SalesPersonFrame(sframe.id,userName);
	...
	public static void main(String args[]) {
		new SalesPersonDetails(1,"Musthafa").setVisible(true);;
	}
}
